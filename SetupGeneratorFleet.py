...
def setupGeneratorFleet(interconn,startYear,fuelPrices,stoEff,stoMinSOC,stoFTLabels,stoInCE,cesmMembers):
...
def compressAndAddSizeDependentParams(genFleet,compressFleet,regElig,contFlexInelig,regCostFrac,stoFTLabels,stoPTLabels):
    ...
    genFleet = addVOM(genFleet)  # genFleet = addVOMandFOM(genFleet,stoPTLabels) 
...
def getATBTechDetailsForWindSolarBattery():
    #Technology types
    solarTech,windTech,batteryTech = 'Utility PV','Land-Based Wind','Utility-Scale Battery Storage' #'Utility PV' for regular runs, 'Utility-Scale PV-Plus-Battery' for CESM2-LE runs!
    #Tech details
    windTechDetail,solarTechDetail,batteryTechDetail = 'Class5', 'Class5', '4Hr Battery Storage'
    return solarTech,windTech,batteryTech,windTechDetail,solarTechDetail,batteryTechDetail

#Get data from NREL's ATB for current year of analysis and input into new techs df
def addVOM(genFleet,scenario='Moderate',dataYear=2020):
    ...
    ptToATBTechAlias = {'Solar PV':solarTech,'Onshore Wind':windTech,'Battery Storage':batteryTech,'Nuclear':'Nuclear',
                    ...
                    'Fossil Waste':'Coal','Tires':'Coal','Fuel Cell':batteryTech}
    feToATBTechDetail = {'Solar PV':solarTechDetail,'Onshore Wind':windTechDetail,'Battery Storage':batteryTechDetail,'Nuclear':'Nuclear',
                    ...
                    'Fossil Waste':'newAvgCF','Tires':'newAvgCF','Fuel Cell':batteryTechDetail}

...
$load pNMaxRegionalWind, pNMaxRegionalSolar, pNMaxTotalWind, pNMaxTotalSolar, pWSGenAsFracOfDemand, pWindGenAsFracOfDemand, pCapactech, pCapacderatetech, pHrtech, pOpcosttech
